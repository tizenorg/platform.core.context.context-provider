...
#ifndef PREDICTION_SINGLE_CATEGORY_ITEM_ID_FILTER_H_
#define PREDICTION_SINGLE_CATEGORY_ITEM_ID_FILTER_H_
...
#endif /* PREDICTION_SINGLE_CATEGORY_ITEM_ID_FILTER_H_ */
