...
int DeviceProviderBase::subscribe(const char *subject, Json option, Json *requestResult)
{
...
int DeviceProviderBase::unsubscribe(const char *subject, Json option)
{
	int ret = ERR_NONE;
...
int DeviceProviderBase::read(const char *subject, Json option, Json *requestResult)
{
	return read();
}

int DeviceProviderBase::write(const char *subject, Json data, Json *requestResult)
{
	return write();
}
