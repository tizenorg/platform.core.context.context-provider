...
#define BATTERY_TABLE_REMOVABLE_BATTERY	"Log_RemovableApp"
#define BATTERY_TABLE_REMOVABLE_BATTERY_COLUMNS \
	"AppId TEXT NOT NULL UNIQUE"

#define BATTERY_TABLE_USAGE_LOG		"Log_AppLaunch"
#define BATTERY_TABLE_USAGE_LOG_COLUMNS \
...
#define BATTERY_TEMP_USAGE_FREQ		"Temp_AppLaunchFreq"
#define BATTERY_TEMP_USAGE_FREQ_SQL \
	"CREATE TABLE IF NOT EXISTS " BATTERY_TEMP_USAGE_FREQ \
