...
ctx::BatteryDbInitializer::BatteryDbInitializer()
{
	__createTable();
	__checkBatteryList();
}
...
void ctx::BatteryDbInitializer::__createTable()
{
...
void ctx::BatteryDbInitializer::__checkBatteryList()
{
	// __dbManager.execute(EMPTY_CHECKER_QID, "SELECT * FROM " APP_TABLE_REMOVABLE_APP " LIMIT 1", this);
}

void ctx::BatteryDbInitializer::__duplicateBatteryList()
{
	int err;
...
bool ctx::BatteryDbInitializer::__packageInfoCb(package_info_h packageInfo, void *userData)
{
...
bool ctx::BatteryDbInitializer::__appInfoCb(package_info_app_component_type_e compType, const char *appId, void *userData)
{
	// Json data;
...
void ctx::BatteryDbInitializer::onTableCreated(unsigned int queryId, int error)
{
}

void ctx::BatteryDbInitializer::onInserted(unsigned int queryId, int error, int64_t rowId)
{
}

void ctx::BatteryDbInitializer::onExecuted(unsigned int queryId, int error, std::vector<Json>& records)
{
